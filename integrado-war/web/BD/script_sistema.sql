/**
 *
 **copyright  2015 yury daniel zavaleta de la cruz
...
estado_existencia int not null default 1,
...
id_empleado_modifica  int(11) not null,
primary key (id_ubicacion_fisica),
foreign key (id_empleado_crea) references empleado (id_empleado),
foreign key (id_empleado_modifica) references empleado (id_empleado)
)engine=innodb;
